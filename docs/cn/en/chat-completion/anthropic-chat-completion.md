...
{% openapi-operation spec="anthropic-en-cn" path="/v1/chat/completions" method="post" %}
[OpenAPI Anthropic](https://raw.githubusercontent.com/liujia-hbu/nsclouds-api-docs/main/docs/bundled/cn/en/anthropic.bundled.yaml)
