...
| 功能 | 状态 | 说明 |
|------|------|------|
| 基础请求 | ✅ 验证通过 | 返回 base64 图片 |
| 图像编辑 | ⏳ 待验证 | - |

### 2. 接口详情

{% openapi-operation spec="google-zh-cn" path="/v1/images/generations" method="post" %}
[OpenAPI Google](https://raw.githubusercontent.com/liujia-hbu/nsclouds-api-docs/main/docs/bundled/cn/zh/google.bundled.yaml)
